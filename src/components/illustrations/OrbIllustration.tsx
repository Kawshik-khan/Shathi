...
export default function OrbIllustration() {
  ...
  return (
    <div className="flex items-center justify-center">
      <motion.div
        aria-hidden
        className="w-48 h-48 rounded-full bg-gradient-to-br from-[#E9F9ED] to-[#E6FFF0] flex items-center justify-center shadow-[0_10px_30px_rgba(34,197,94,0.06)]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        >
          <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
            <circle cx="34" cy="34" r="34" fill="#DFF7E6" />
