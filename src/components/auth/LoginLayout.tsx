...
export default function AuthLayout({ children }: Props) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F8FBF8] p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="w-full max-w-xs sm:max-w-sm md:max-w-2xl lg:max-w-5xl xl:max-w-7xl rounded-2xl sm:rounded-3xl lg:rounded-4xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] overflow-hidden bg-white/60 backdrop-blur-sm">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="hidden lg:flex p-6 sm:p-8 lg:p-10 xl:p-12 flex-col justify-center gap-6 sm:gap-7 lg:gap-8 bg-gradient-to-b from-[#F5FAF5] to-[#EEF7EF]">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm sm:text-base font-medium text-[#0F172A]">Sathi</div>
              </div>
            </div>

            <div>
              <div className="inline-flex items-center gap-2 sm:gap-3 bg-[#EAF6EA] text-[#175E2B] px-3 py-1 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm">
                <span className="w-2 h-2 rounded-full bg-[#5DBB63] block" />
              ...
              <h1 className="mt-4 sm:mt-6 text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#0F172A] leading-tight sm:leading-snug">
                {isSignup ? 'Join Sathi' : 'Welcome back'}<br />to Sathi <span className="text-[#5DBB63]">🌿</span>
              </h1>
