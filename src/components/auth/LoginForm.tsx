  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 shadow-sm">
      <div className="text-center mb-5 sm:mb-6">
        ...
        <h2 className="mt-3 sm:mt-4 text-xl sm:text-2xl font-bold text-[#0F172A]">Welcome back</h2>
        <p className="mt-2 text-xs sm:text-sm text-[#64748B] leading-relaxed">Log in to continue your wellness journey with Sathi.</p>
      </div>
      ...
      <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center justify-between text-xs sm:text-sm gap-2">
          ...
          <button
            ...
            className="text-[#22C55E] hover:underline whitespace-nowrap bg-transparent border-none p-0 cursor-pointer"
          >
            Forgot password?
          </button>
        </div>
        ...
        <p className="text-center text-xs sm:text-sm text-[#64748B] mt-4 sm:mt-5">Don&apos;t have an account? <a href="/auth/signup" className="text-[#22C55E] font-medium hover:underline">Sign up</a></p>
      </form>
    </div>
  );
}
