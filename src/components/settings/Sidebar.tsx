  ...
  return (
    <nav aria-label="Settings sections" className="glass-card p-4 sticky top-20">
      <div className="mb-4">
        ...
        <p className="text-sm text-slate-500">Personalize your Sathi experience</p>
      </div>
      ...
      <ul className="space-y-2" role="list">
        {sections.map((s) => {
          ...
          const bgClass = isActive ? 'bg-[#DCFCE7] text-[#0F172A]' : 'hover:bg-white/40'
