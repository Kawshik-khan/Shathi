        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <GlassCard delay={0.25}>
            ...
            <div className="space-y-3">
              {content.map((item) => (
                <div key={item.id} className="p-3 rounded-xl bg-[#F3FAF4]">
          ...
          <GlassCard delay={0.3}>
            ...
            <div className="space-y-3">
              {crisisResources.map((resource) => (
                <div key={resource.id} className="p-3 rounded-xl bg-[#F3FAF4]">
                  <div className="flex items-center justify-between gap-3 mb-1">
                    <h3 className="font-medium text-foreground">{resource.name}</h3>
                    {resource.is_24_7 && <span className="text-xs text-[#22C55E]">24/7</span>}
                  </div>
